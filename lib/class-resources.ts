 ...
 */
export function getRechargeColor(recharge: 'short' | 'long'): string {
  return recharge === 'short' ? '#f59e0b' : '#3b82f6' // amber for short, blue for long
}

/**
 * Get Italian label for recharge type
 */
export function getRechargeLabel(recharge: 'short' | 'long'): string {
  return recharge === 'short' ? 'Riposo Breve' : 'Riposo Lungo'
}
